...
class RectangularRoom(object):
    ...
    def isPositionInRoom(self, pos):
        ...
        if x < 0 or y < 0:
            ...
            return x < math.floor(self.width) and y < math.floor(self.height)
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        """
        robotPos = room.getRandomPosition()
        robotDir = random.randint(0, 359)
        self.room = room
        self.speed = speed
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    anim.done()        
    return float(int(step / num_trials))
...
def showPlot():
    """
    Produces a plot showing the mean number of time-steps that a various number
    of robots need to clean a fraction of a room with given parameters.
    The plot compares effectiveness of two types of robots tested.
    Number of robots: 1-10
    Speed: 1.0
    Room size: 20x20
    Min coverage: 0.8
    Number of trials: 20
    Robot types: StandardRobot and RandomWalkRobot
    """
    ...
    pylab.title("Work effectiveness of two types of robots")
